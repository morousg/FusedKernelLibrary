...
constexpr bool test_fuseDFResultingTypes() {
    ...
    constexpr auto fused1 = Fuser::fuseIOps(readOp, addOp, castOp);
    ...
    constexpr auto fused2 = fk::Fuser::fuseIOps(readOp, addOp, writeOp);
...
constexpr bool test_fuseFusedOperations() {
    ...
    const auto fused1 = fk::Fuser::fuseIOps(readOp, addOp);
    [[maybe_unused]] const auto fused2 = fk::Fuser::fuseIOps(fused1, castOp);
