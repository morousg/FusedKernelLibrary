...
// ####################### VECTOR OPERATORS ##########################
// Extended to cover all fk::StandardTypes as input parameters

// Addition
VEC_BINARY_OP(+, bool, int)
...
VEC_BINARY_OP(+, ulong, ulong)
VEC_BINARY_OP(+, long, long)
VEC_BINARY_OP(+, ulonglong, ulonglong)
VEC_BINARY_OP(+, longlong, longlong)
...
SCALAR_BINARY_OP(+, long, uint, uint)
SCALAR_BINARY_OP(+, long, float, float)
SCALAR_BINARY_OP(+, long, double, double)
...
SCALAR_BINARY_OP(== , uchar, uchar, bool)
SCALAR_BINARY_OP(== , char, char, bool)
SCALAR_BINARY_OP(== , ushort, ushort, bool)
SCALAR_BINARY_OP(== , short, short, bool)
SCALAR_BINARY_OP(== , int, int, bool)
SCALAR_BINARY_OP(== , uint, uint, bool)
SCALAR_BINARY_OP(== , long, long, bool)
SCALAR_BINARY_OP(== , ulong, ulong, bool)
SCALAR_BINARY_OP(== , longlong, longlong, bool)
SCALAR_BINARY_OP(== , ulonglong, ulonglong, bool)
SCALAR_BINARY_OP(== , float, float, bool)
SCALAR_BINARY_OP(== , double, double, bool)
...
SCALAR_BINARY_OP(&, int, int, int)
SCALAR_BINARY_OP(&, uint, uint, uint)
SCALAR_BINARY_OP(&, long, long, long)
SCALAR_BINARY_OP(&, ulong, ulong, ulong)
SCALAR_BINARY_OP(&, longlong, longlong, longlong)
SCALAR_BINARY_OP(&, ulonglong, ulonglong, ulonglong)
